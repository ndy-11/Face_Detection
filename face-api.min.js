!(function (t, e) {
  ...
  function x(t, e) {
    if ((void 0 === e && (e = []), null == e && (e = []), Array.isArray(t) || z(t))) for (var n = 0; n < t.length; ++n) x(t[n], e);
    else e.push(t);
    return e;
  }
  ...
  var dt = (function () {
    ...
    return (
      ...
      (o.prototype.batchNormalization = function (t, e, n, r, o) {
        return void 0 === n && (n = 0.001), ft("tf.batchNormalization() is going away. Use tf.batchNorm() instead, and note the positional argument change of scale, offset, and varianceEpsilon"), this.batchNorm(t, e, o, r, n);
      }),
      (o.prototype.batchNorm = function (t, e, n, r, o) {
        return void 0 === o && (o = 0.001), this.throwIfDisposed(), pt.batchNorm(this, t, e, n, r, o);
      }),
      ...
      (o.prototype.leakyRelu = function (t) {
        return void 0 === t && (t = 0.2), this.throwIfDisposed(), pt.leakyRelu(this, t);
      }),
      ...
      (o.prototype.localResponseNormalization = function (t, e, n, r) {
        return void 0 === t && (t = 5), void 0 === e && (e = 1), void 0 === n && (n = 1), void 0 === r && (r = 0.5), pt.localResponseNormalization(this, t, e, n, r);
      }),
      ...
      return (
        ...
        (t.prototype.memory = function () {
          ...
          return (
            ...
            0 < this.numStringTensors && ((t.unreliable = !0), null == t.reasons && (t.reasons = []), t.reasons.push("Memory usage by string tensors is approximate (2 bytes per character)")),
            t
          );
        }),
            ...
            function () {
              ...
              return (
                ...
                e.runKernel(
                  function (t, e) {
                    return (
                      D((i = r.apply(void 0, a.concat([e]))).value instanceof dt, function () {
    ...
    if (Ut in n) {
      ...
      n[Ut].split(",").forEach(function (t) {
        ...
        Wt.forEach(function (t) {
          t.name in o &&
            (console.log("Setting feature override from URL " + t.name + ": " + o[t.name]),
            t.type === Mt.NUMBER ? (e[t.name] = +o[t.name]) : t.type === Mt.BOOLEAN ? (e[t.name] = "true" === o[t.name]) : t.type === Mt.STRING ? (e[t.name] = o[t.name]) : console.warn("Unknown URL param: " + t.name + "."));
        });
    }
    return e;
  }
  ...
  var We = Fe({
      complex_: function (t, e) {
        var n = re(t, "real", "complex"),
          r = re(e, "imag", "complex");
        return (
          g(n.shape, r.shape, "real and imag shapes, " + n.shape + " and " + r.shape + ", must match in call to tf.complex()."),
          Zt.engine.runKernel(
            function (t) {
                  ...
                  ? (function (t, e) {
                      ...
                      if (1 === a && 1 < s) f = "\n      return vec4(outputValue.xy, outputValue.xy);\n    ";
                        ...
                        -1 < u.indexOf(d) && -1 < u.indexOf(v)
                          ...
                          : -1 < u.indexOf(v) && (f = "return vec4(outputValue.xx, outputValue.zz);");
                      }
      ...
      (a = e.isPacked
        ? ((i = (function (t, e) {
            switch (t.length) {
              ...
              default:
                return (function (t, e) {
                  for (var n = [Math.ceil(e[0] / 2), Math.ceil(e[1] / 2)], r = Math.ceil(t[t.length - 1] / 2), o = r * Math.ceil(t[t.length - 2] / 2), i = o, a = "", s = "b, r, c", u = 2; u < t.length - 1; u++)
  ...
  function fo(t, e) {
    ...
    return (
      (c =
        2 === Zt.get("WEBGL_VERSION")
          ? ((n = l.R32F), (r = l.R16F), (o = l.RGBA16F), (i = l.RGBA32F), (a = l.RED), (s = 4), (u = 1), l.HALF_FLOAT)
          : ((n = t.RGBA), (r = t.RGBA), (o = t.RGBA), (i = l.RGBA), (a = t.RGBA), (u = s = 4), null != e ? e.HALF_FLOAT_OES : null)),
      {
      ...
      function t(t) {
        ...
        null != t ? ((this.gl = t), (e = t), (i[n] = e)) : (this.gl = l(n)),
          1 === Zt.get("WEBGL_VERSION")
            ? ((this.textureFloatExtension = Or(this.gl, this.debug, "OES_texture_float")),
              (this.colorBufferFloatExtension = this.gl.getExtension("WEBGL_color_buffer_float")),
              Zt.get("WEBGL_RENDER_FLOAT32_ENABLED") || ((this.textureHalfFloatExtension = Or(this.gl, this.debug, "OES_texture_half_float")), (this.colorBufferHalfFloatExtension = this.gl.getExtension("EXT_color_buffer_half_float"))))
            : (this.colorBufferFloatExtension = Or(this.gl, this.debug, "EXT_color_buffer_float")),
        ...
        (t.prototype.getQueryTimerExtension = function () {
          return (
            null == this.disjointQueryTimerExtension &&
              (this.disjointQueryTimerExtension = Or(this.gl, this.debug, 2 === Zt.get("WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_VERSION") ? "EXT_disjoint_timer_query_webgl2" : "EXT_disjoint_timer_query")),
    ...
    Ho = function (n, t, e) {
      ...
      for (
        var r = n.length,
          ...
          p = 1 === r ? "rc < start || rc >= end" : "any(lessThan(rc, start)) || any(greaterThanEqual(rc, end))",
          f = "",
          d = 0,
          v = 1 === r ? 2 : 4;
        d < v;
      ...
      this.userCode =
        1 === t
          ...
          : "\n        void main() {\n          " +
            ...
            s +
            ") {\n              result.a = " +
            (((e = o.slice())[t - 1] = "(" + e[t - 1] + " + 1)"), (e[t - 2] = "(" + e[t - 2] + " + 1)"), l(e)) +
            ";\n            }\n          }\n          setOutput(result);\n        }\n    ";
    },
        ...
        (t.prototype.acquireTexture = function (t, e, n) {
          ...
          return (
            ...
            o === br.PACKED_2X2_FLOAT32
              ...
              : o === br.PACKED_4X1_UNSIGNED_BYTE && (r = this.gpgpu.createUnsignedBytesMatrixTexture(t[0], t[1])),
              ...
              (i.next = function () {
                ...
                (function (t, e) {
                  var n,
                    ...
                    s = [],
                    u = 128;
                  for (e === (0 | e) ? ((r = e), (e = null)) : ((e += "\0"), (r = 0), (u = Math.max(u, e.length))), o = 0, i = -32; i < u; ++i)
              ...
              return {
                $x: function () {
                  ...
                  if (1 === a.rank) for (var e = 0; e < s[0]; ++e) t = t.add(i.slice([e * a.shape[0]], [a.shape[0]]));
                    ...
                    for (e = 0; e < s[0]; ++e)
                      for (n = 0; n < s[1]; ++n)
                        for (r = 0; r < s[2]; ++r) for (var o = 0; o < s[3]; ++o) t = t.add(i.slice([e * a.shape[0], n * a.shape[1], r * a.shape[2], o * a.shape[3]], [a.shape[0], a.shape[1], a.shape[2], a.shape[3]]));
                  }
                  return t;
                },
              };
  ...
  var va = (function () {
    ...
    return (
      ...
      (t.prototype.fromPixels = function (t, e) {
        ...
        if (Zt.get("IS_BROWSER")) {
          if (!(t instanceof HTMLVideoElement || t instanceof HTMLImageElement || t instanceof HTMLCanvasElement || t instanceof ImageData))
            throw new Error("pixels passed to tf.browser.fromPixels() must be either an HTMLVideoElement, HTMLImageElement, HTMLCanvasElement or ImageData, but was " + t.constructor.name);
          if (t instanceof HTMLVideoElement) {
            if (null == this.fromPixels2DContext) {
              if ("complete" !== document.readyState)
                throw new Error("The DOM is not ready yet. Please call tf.browser.fromPixels() once the DOM is ready. One way to do that is to add an event listener for `DOMContentLoaded` on the document object");
          ...
          return R(this, function (t) {
            switch (t.label) {
              case 0:
                ...
                if (((o = this.texData.get(S)), (i = o.texture), (a = o.values), (s = o.texShape), (u = o.isPacked), (c = o.shape), (l = o.slice), (h = o.dtype), null != l))
                  return (
                    (p = new mi(c, wi)),
                ...
                return (
                  ...
                  (y =
                    g instanceof WebGLTexture
                      ...
                      : ((x = B(c)),
                        u
                          ? ((w = oo(c)), (E = b = 1), c.length && ((n = io(c)), (b = n[0]), (E = n[1])), this.gpgpu.downloadPackedMatrixFromBuffer(g, w, b, E, s[0], s[1]).subarray(0, x))
                          : this.gpgpu.downloadFloat32MatrixFromBuffer(g, s[0], s[1]).subarray(0, x))),
      ...
      (t.prototype.depthwiseConv2D = function (t, e, n) {
        var r;
        return Zt.get("WEBGL_PACK_DEPTHWISECONV") && n.strideWidth <= 2 && n.outChannels / n.inChannels == 1
          ? ((r = new ur(n)), this.compileAndRun(r, [t, e], this.makePackedTensor(n.outShape, t.dtype)))
      ...
      (t.prototype.compileAndRun = function (o, t, e, n, r) {
        var i = this;
        if ((void 0 === r && (r = !0), null == e && (e = o.usesPackedTextures ? this.makePackedTensor(o.outputShape, t[0].dtype) : this.makeOutputArray(o.outputShape, t[0].dtype)), 0 === e.size))
        ...
        var a = t.map(function (t) {
          ...
          if (null == e.texture) {
            if (!o.usesPackedTextures && B(t.shape) <= Zt.get("WEBGL_SIZE_UPLOAD_UNIFORM"))
              return {
                shape: t.shape,
                texData: null,
                isUniform: !0,
            ...
            return (function (t, r, e, n) {
              var o = r.userCode,
                i = e.map(function (t, e) {
                  ...
                  return (
                    null != t.texData && null != t.texData.slice && 0 < t.texData.slice.flatOffset && (n.flatOffset = t.texData.slice.flatOffset),
                    {
      ...
      (t.prototype.convertAndCacheOnCPU = function (t, e) {
        var n = this.texData.get(t),
          ...
          s = n.isPacked;
        return (
          null != r && (this.releaseTexture(t, r, o, a, i, s), (n.texture = null), (n.texShape = null), (n.isPacked = !1)),
          (n.usage = wr.UPLOAD),
          null != e &&
  ...
  function fs(t, e, n, r, o, i, a, s) {
    ...
    var f,
      ...
      I = a ? m * p : m;
    return (
      "channelsFirst" === s ? (f = [c, I, N, k]) : "channelsLast" === s && (f = [c, N, k, I]),
      {
        batchSize: c,
        dataFormat: s,
        inHeight: l,
  ...
  function ds(t, e, n, r, o, i, a) {
    ...
    var f,
      ...
      A = i ? g * p : g;
    return (
      "channelsFirst" === a ? (f = [u, A, k, I, T]) : "channelsLast" === a && (f = [u, k, I, T, A]),
      {
        batchSize: u,
        dataFormat: a,
        inDepth: c,
    ...
    Ac = Fe({
      qr_: function (t, o) {
        ...
        var e = t.shape.slice(0, t.shape.length - 2).reduce(function (t, e) {
          ...
          a = [];
        return (
          ha(t.reshape([e, t.shape[t.shape.length - 2], t.shape[t.shape.length - 1]]), 0).forEach(function (t) {
            var e = Ic(t, o),
              n = e[0],
              r = e[1];
            i.push(n), a.push(r);
  ...
  var Vc = (function () {
    ...
    return (
      ...
      (t.prototype.conv2d = function (t, e, n) {
        ...
        for (
          var r = n.filterHeight, o = n.filterWidth, i = n.dilationHeight, a = n.dilationWidth, s = n.padInfo.left, u = n.padInfo.top, c = zi(n.outShape, t.dtype), l = t.dataSync(), h = e.dataSync(), p = c.values, f = 0;
          f < n.batchSize;
          ++f
        )
            ...
            for (var O = 0; O < C; ++O)
              for (var P = O - T, F = Math.max(0, Math.ceil(P / k)), L = Math.min(R, (w + P) / k), B = 0; B < _; ++B) {
                for (var W = B - A, z = Math.max(0, Math.ceil(W / I)), U = Math.min(N, (b + W) / I), G = 0, V = F; V < L; ++V)
                  for (var H = V * k - P, q = z; q < U; ++q) for (var j = h * D + p * V + f * q, $ = m * (w - 1 - H) + g * (b - 1 - (q * I - W)) + y * M, K = 0; K < S; ++K) G += c[j + K] * d[$ + K];
                o[a * D + s * O + u * B + M] = G;
              }
        return r.toTensor();
      }),
            ...
            for (var P = 0; P < C; ++P)
              for (var F = P - T, L = Math.max(0, Math.ceil(F / k)), B = Math.min(R, (w + F) / k), W = 0; W < _; ++W) {
                for (var z = W - A, U = Math.max(0, Math.ceil(z / I)), G = Math.min(N, (b + z) / I), V = 0, H = L; H < B; ++H)
                  for (var q = H * k - F, j = U; j < G; ++j) for (var $ = h * M + p * H + f * j, K = m * (w - 1 - q) + g * (b - 1 - (j * I - z)) + y * O, X = 0; X < D; ++X) V += c[$ + (O * D + X)] * d[K + X];
                o[a * M + s * P + u * W + O] = V;
              }
        return r.toTensor();
      }),
      ...
      (t.prototype.batchNormalization = function (t, e, n, r, o, i) {
        ...
        for (
          ...
          (h[w] = l[m++] + ((a[w] - s[g++]) * c[y++]) / Math.sqrt(u[x++] + r)), p <= m && (m = 0), v <= g && (g = 0), f <= y && (y = 0), d <= x && (x = 0);
        return $e(h, t.shape);
      }),
      ...
      (t.prototype.cropAndResize = function (t, e, n, r, o, i) {
        for (
          var a = t.shape, s = a[0], u = a[1], c = a[2], l = a[3], h = e.shape[0], p = r[0], f = r[1], d = zi([h, p, f, l], t.dtype), v = e.dataSync(), m = n.dataSync(), g = t.dataSync(), y = t.strides, x = d.strides, w = 0;
          w < h;
          w++
        ) {
          var b = 4 * w,
            ...
            for (var N = 1 < p ? ((_ - E) * (u - 1)) / (p - 1) : 0, k = 1 < f ? ((S - C) * (c - 1)) / (f - 1) : 0, I = 0; I < p; I++) {
              ...
              if (T < 0 || u - 1 < T)
                ...
                var O = Math.floor(T),
                  ...
                  F = T - O;
                for (A = 0; A < f; A++)
                  if ((q = 1 < f ? C * (c - 1) + A * k : 0.5 * (C + S) * (c - 1)) < 0 || c - 1 < q) for (D = 0; D < l; D++) (M = D + A * x[2] + I * x[1] + w * x[0]), (d.values[M] = i);
                  else {
                    var L = Math.floor(q),
                      B = Math.ceil(q),
                      W = q - L;
  ...
  var Jc = (function () {
      ...
      return (
        ...
        (i.getHandlers = function (n, t, r) {
          var o = [];
          return (
            ("load" === t ? i.getInstance().loadRouters : i.getInstance().saveRouters).forEach(function (t) {
              var e = t(n, r);
              null !== e && o.push(e);
            }),
            o
    ...
    return (
      ...
      (t.prototype.removeModel = function (u) {
        return m(this, void 0, void 0, function () {
          ...
          return R(this, function (t) {
            return (
              (u = (e = u).startsWith(ul.URL_SCHEME) ? e.slice(ul.URL_SCHEME.length) : e),
              [
                2,
        ...
        (t.prototype.load = function () {
          return m(this, void 0, void 0, function () {
            ...
            return R(this, function (t) {
              ...
              if (
                ((n.weightSpecs = o),
                null != (i = this.LS.getItem(this.keys.modelMetadata)) && ((a = JSON.parse(i)), (n.format = a.format), (n.generatedBy = a.generatedBy), (n.convertedBy = a.convertedBy)),
          ...
          return R(this, function (t) {
            switch (t.label) {
              ...
              case 2:
                ...
                return [4, e.data()];
              case 3:
                for (l = t.sent(), h = "float32" === e.dtype ? 255 : 1, p = new Uint8ClampedArray(o * r * 4), f = 0; f < r * o; ++f)
                  (g = m = v = d = void 0),
                    1 === i
                      ? ((d = l[f] * h), (v = l[f] * h), (m = l[f] * h), (g = 255))
                      : 3 === i
                      ? ((d = l[3 * f] * h), (v = l[3 * f + 1] * h), (m = l[3 * f + 2] * h), (g = 255))
                      : 4 === i && ((d = l[4 * f] * h), (v = l[4 * f + 1] * h), (m = l[4 * f + 2] * h), (g = l[4 * f + 3] * h)),
  ...
  function Vl(t, e, n) {
    return (
      ...
      Hl(t, "number" == typeof e || "boolean" == typeof e ? [e] : e, function (t, e) {
  ...
  function Hl(t, e, n) {
    ...
    var i, a;
    if (((i = t instanceof dt ? t.dataSync() : t), (a = e instanceof dt ? e.dataSync() : e), i.length !== a.length))
  ...
  var jl = Object.freeze({
      ...
      expectArraysEqual: function (t, e) {
        ...
        return (t instanceof dt && "string" === t.dtype) || (e instanceof dt && "string" === e.dtype) || (Array.isArray(t) && V(t[0])) || (Array.isArray(e) && V(e[0]))
          ? Hl(t, n, function (t, e) {
              return t == e;
            })
          : Vl(t, e, 0);
  ...
  var nh = (function () {
      ...
      return (
        ...
        (t.rmsprop = function (t, e, n, r, o) {
          return void 0 === e && (e = 0.9), void 0 === n && (n = 0), void 0 === r && (r = null), void 0 === o && (o = !1), new eh(t, e, n, r, o);
        }),
        (t.adam = function (t, e, n, r) {
          return void 0 === t && (t = 0.001), void 0 === e && (e = 0.9), void 0 === n && (n = 0.999), void 0 === r && (r = null), new Ql(t, e, n, r);
        }),
        (t.adadelta = function (t, e, n) {
          return void 0 === t && (t = 0.001), void 0 === e && (e = 0.95), void 0 === n && (n = null), new Xl(t, e, n);
        }),
        (t.adamax = function (t, e, n, r, o) {
          return void 0 === t && (t = 0.002), void 0 === e && (e = 0.9), void 0 === n && (n = 0.999), void 0 === r && (r = null), void 0 === o && (o = 0), new Jl(t, e, n, r, o);
        }),
  ...
  var gp = (function () {
    function t(t, e) {
      void 0 === e && (e = !1);
      var o = this;
      if (((this._imageTensors = []), (this._canvases = []), (this._treatAsBatchInput = !1), (this._inputDimensions = []), !Array.isArray(t)))
  ...
  var Mp = (function () {
      function t(t) {
        var e = void 0 === t ? {} : t,
          n = e.inputSize,
          r = e.scoreThreshold;
        if (((this._name = "TinyYolov2Options"), (this._inputSize = n || 416), (this._scoreThreshold = r || 0.5), "number" != typeof this._inputSize || this._inputSize % 32 != 0))
      ...
      return (
        ...
        (r.prototype.runTinyYolov2 = function (t, e) {
          ...
          return (
            ...
            Kh((n = Ip((n = Ip((n = Us(n, [2, 2], [1, 1], "same")), e.conv6)), e.conv7)), e.conv8, "valid", !1)
          );
        }),
                    ...
                    ? ((y = Cp(f[v][m][g][0])),
                      !M || M < y
                        ? ((x = ((m + Cp(d[v][m][g][0])) / a) * o),
                          ...
                          (b = ((Math.exp(d[v][m][g][2]) * this.config.anchors[g].x) / a) * o),
                          (E = ((Math.exp(d[v][m][g][3]) * this.config.anchors[g].y) / a) * i),
                          (C = x - b / 2),
                          (_ = w - E / 2),
                          (S = {
                            row: v,
                          ...
                          this.withClassScores ? [4, this.extractPredictedClass(h, S)] : [3, 7])
                        : [3, 9])
                    : [3, 10];
                case 6:
                  return (I = t.sent()), [3, 8];
      ...
      return (
        ...
        (t.prototype.forwardInput = function (e) {
          ...
          return ue(function () {
            ...
            return (
              (o = pf((o = pf(o, i.entry_flow.reduction_block_0, !1)), i.entry_flow.reduction_block_1)),
              ...
              (t = Af(
                (t = Af(
                  (t = Df(
                    (t = Af(
                      (t = Af(
                        (t = Df((t = Af((t = Af((t = Af((t = Df((t = Af((t = Af((t = Af((t = Us(t, 3, 2, "valid")), r.conv32_1)), r.conv32_2)), r.conv32_3)), r.conv64_down)), r.conv64_1)), r.conv64_2)), r.conv64_3)), r.conv128_down)),
                        r.conv128_1
                      )),
                      r.conv128_2
                    )),
  ...
  var Hf = (function () {
      function t(t) {
        var e = void 0 === t ? {} : t,
          n = e.minConfidence,
          r = e.maxResults;
        if (((this._name = "SsdMobilenetv1Options"), (this._minConfidence = n || 0.5), (this._maxResults = r || 100), "number" != typeof this._minConfidence || this._minConfidence <= 0 || 1 <= this._minConfidence))
    ...
    return (
      ...
      ue(function () {
        ...
        return (
          ...
          (t = id((t = Kh((t = Us(t, r ? [2, 2] : [3, 3], [2, 2], "same")), n.conv2, "valid")), n.prelu2_alpha)),
          (t = id((t = Kh((t = r ? t : Us(t, [3, 3], [2, 2], "valid")), n.conv3, "valid")), n.prelu3_alpha))
        );
      })
    );
  }
  ...
  var hd = (function (t) {
                ...
                switch (t.label) {
                  ...
                  case 1:
                    return (
                      ...
                      y.boxes.length
                        ? ((r.stage2_numInputBoxes = y.boxes.length), (g = Date.now()), [4, cd(n, y.boxes, d[1], e.rnet, r)])
                        : [
                            2,
                            a({
                              results: [],
                  ...
                  case 2:
                    return (
                      ...
                      x.boxes.length
                        ? ((r.stage3_numInputBoxes = x.boxes.length), (g = Date.now()), [4, ld(n, x.boxes, d[2], e.onet, r)])
                        : [
                            2,
                            a({
                              results: [],
    ...
    vd = [new lh(0.738768, 0.874946), new lh(2.42204, 2.65704), new lh(4.30971, 7.04493), new lh(10.246, 4.59428), new lh(12.6868, 11.8741)],
